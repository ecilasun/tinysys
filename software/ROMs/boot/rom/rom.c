...
void __attribute__((aligned(64), noinline)) UserMain()
{
	...
	_task_add(taskctx, "CPUIdle", _stubTask, TS_RUNNING, HUNDRED_MILLISECONDS_IN_TICKS, self, self, 0 /*no gp*/, TASK_STACK_POINTER(self, 0));
...
void __attribute__((aligned(64), noinline)) KernelMain()
{
	...
	_task_add(taskctx[0], "CPUIdle", _stubTask, TS_RUNNING, HUNDRED_MILLISECONDS_IN_TICKS, self, self, 0 /*no gp*/, TASK_STACK_POINTER(self, 0));
	_task_add(taskctx[0], "CLI", _CLITask, TS_RUNNING, HUNDRED_MILLISECONDS_IN_TICKS, self, self, 0 /*no gp*/, TASK_STACK_POINTER(self, 1));
