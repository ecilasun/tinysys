...
module arbiter(
	input wire aclk,
	input wire aresetn,
	axi4if.slave axi_s[6:0],	// To slave in ports of master devices
...
typedef enum logic [3:0] {INIT, ARBITRATE0, ARBITRATE1, ARBITRATE2, ARBITRATE3, ARBITRATE4, ARBITRATE5, ARBITRATE6, GRANTED} arbiterstatetype;
...
genvar rreqgen;
generate
for (rreqgen=0; rreqgen<7; rreqgen++) begin
	always_comb begin
...
always_ff @(posedge aclk) begin
	unique case(readstate)
		...
		ARBITRATE0: begin
			...
			priority case(1'b1)
				rreq[1]: begin rgrant <= 7'b0000010; rarbstate <= ARBITRATE1; end
				rreq[2]: begin rgrant <= 7'b0000100; rarbstate <= ARBITRATE2; end
				rreq[3]: begin rgrant <= 7'b0001000; rarbstate <= ARBITRATE3; end
				rreq[4]: begin rgrant <= 7'b0010000; rarbstate <= ARBITRATE4; end
				rreq[5]: begin rgrant <= 7'b0100000; rarbstate <= ARBITRATE5; end
				rreq[6]: begin rgrant <= 7'b1000000; rarbstate <= ARBITRATE6; end
				rreq[0]: begin rgrant <= 7'b0000001; rarbstate <= ARBITRATE0; end
				default: rgrant <= 7'b0000000;
			endcase
		end
...
genvar wreqgen;
generate
for (wreqgen=0; wreqgen<7; wreqgen++) begin
	always_comb begin
...
always_ff @(posedge aclk) begin
	unique case(writestate)
		...
		ARBITRATE0: begin
			...
			priority case(1'b1)
				wreq[1]: begin wgrant <= 7'b0000010; warbstate <= ARBITRATE1; end
				wreq[2]: begin wgrant <= 7'b0000100; warbstate <= ARBITRATE2; end
				wreq[3]: begin wgrant <= 7'b0001000; warbstate <= ARBITRATE3; end
				wreq[4]: begin wgrant <= 7'b0010000; warbstate <= ARBITRATE4; end
				wreq[5]: begin wgrant <= 7'b0100000; warbstate <= ARBITRATE5; end
				wreq[6]: begin wgrant <= 7'b1000000; warbstate <= ARBITRATE6; end
				wreq[0]: begin wgrant <= 7'b0000001; warbstate <= ARBITRATE0; end
				default: wgrant <= 7'b0000000;
			endcase
		end
