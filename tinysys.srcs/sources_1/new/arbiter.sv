...
module arbiter(
	input wire aclk,
	input wire aresetn,
	axi4if.slave axi_s[4:0],	// To slave in ports of master devices
...
genvar rreqgen;
generate
for (rreqgen=0; rreqgen<5; rreqgen++) begin
	always_comb begin
	...
	if (~aresetn) begin
		...
		unique case(readstate)
			...
			ARBITRATE0: begin
				...
				priority case(1'b1)
					rreq[1]: begin rgrant <= 5'b00010; rarbstate <= ARBITRATE1; end
					rreq[2]: begin rgrant <= 5'b00100; rarbstate <= ARBITRATE2; end
					rreq[3]: begin rgrant <= 5'b01000; rarbstate <= ARBITRATE3; end
					rreq[4]: begin rgrant <= 5'b10000; rarbstate <= ARBITRATE4; end
					rreq[0]: begin rgrant <= 5'b00001; rarbstate <= ARBITRATE0; end
					default: rgrant = 5'b00000;
				endcase
			end
...
genvar wreqgen;
generate
for (wreqgen=0; wreqgen<5; wreqgen++) begin
	always_comb begin
	...
	if (~aresetn) begin
		...
		unique case(writestate)
			...
			ARBITRATE0: begin
				...
				priority case(1'b1)
					wreq[1]: begin wgrant <= 5'b00010; warbstate <= ARBITRATE1; end
					wreq[2]: begin wgrant <= 5'b00100; warbstate <= ARBITRATE2; end
					wreq[3]: begin wgrant <= 5'b01000; warbstate <= ARBITRATE3; end
					wreq[4]: begin wgrant <= 5'b10000; warbstate <= ARBITRATE4; end
					wreq[0]: begin wgrant <= 5'b00001; warbstate <= ARBITRATE0; end
					default: wgrant <= 5'b00000;
				endcase
			end
