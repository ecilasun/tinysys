...
#
# Generated by export_simulation on Mon Nov 07 21:37:30 -0800 2022
#
################################################################################
...
'-reset_run' switch to the './ddr3clkgen.sh' script.

./ddr3clkgen.sh -reset_run
...
./ddr3clkgen.sh -noclean_files

For more information on the script, please type './ddr3clkgen.sh -help'.
