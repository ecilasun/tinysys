...
#
# Generated by export_simulation on Sun Jan 08 23:12:34 -0800 2023
#
################################################################################
...
'-reset_run' switch to the './coreclockgen.sh' script.

./coreclockgen.sh -reset_run
...
./coreclockgen.sh -noclean_files

For more information on the script, please type './coreclockgen.sh -help'.
